...
def run_parser():
    ...
    # Собираем список букв, на которые есть фамилии
    used_letters = set()
...
# ========================
# Функция ожидания до нужного времени (19:00 и 00:00 по Москве)
# ========================
...
@app.route("/")
def index():
    return "✅ Парсинг запущен. Скрипт работает в фоне."
...
# ========================
# Запуск сервера Flask и фонового парсера
# ========================
