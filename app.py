...
def run_parser():
    ...
    # Вычисляем дату 3 месяцев назад
    three_months_ago = today - timedelta(days=3*30)  # Приблизительно 3 месяца

    # Фильтруем DataFrame: оставляем строки, где дата >= three_months_ago и дата известна (не NaT)
